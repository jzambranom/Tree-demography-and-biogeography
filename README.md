...
•	Results are stored in Results/Demographic models/. Results from survival and growth Bayesian models are stored in /Demography as well as the code to obtain Figure 5.
